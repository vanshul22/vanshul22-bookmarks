                    ...
                    <div className="text-white">
                        ...
                        <form action="#">
                            ...
                            <div className="mt-8 flex justify-center text-lg text-black">
                                <Button type='submit' className='rounded-3xl bg-black hover:bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300'>Sign Up</Button>
                            </div>
                        </form>
                        ...
                        <div className=" flex justify-between text-lg ">
                            ...
                            <Link className='text-sm font-medium leading-none' href="/auth/signin">Sign In</Link>
                        </div>
                    </div>
                </div>
            </div>
